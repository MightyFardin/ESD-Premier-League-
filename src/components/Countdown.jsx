    ...
    <div className="flex justify-center gap-2 sm:gap-4 my-8 animate-slide-up" style={{ animationDelay: '300ms' }}>
      {Object.entries(timeLeft).map(([unit, value]) => (
        <div key={unit} className="flex flex-col items-center">
          <div className="w-14 h-14 sm:w-20 sm:h-20 bg-white/40 dark:bg-black/40  rounded-2xl border border-slate-200/50 dark:border-white/10 flex items-center justify-center shadow-lg hover:bg-white/60 dark:hover:bg-black/60 transition-colors">
